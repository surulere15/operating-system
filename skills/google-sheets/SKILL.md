...
- Access is scoped to spreadsheets, sheets, cells, and data ranges within the connected Google Sheets account.
...
- Correct: `https://api.maton.ai/google-sheets/v4/spreadsheets/SPREADSHEET_ID`
- Incorrect: `https://api.maton.ai/v4/spreadsheets/SPREADSHEET_ID`
